...
module Pqapiv2
  ...
  class PaperCheckCollectionResponse < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [List of PaperCheck]
    ...
    def self.from_hash(hash)
      ...
      unless hash['payload'].nil?
        ...
        hash['payload'].each do |structure|
          payload << (PaperCheck.from_hash(structure) if structure)
        end
      end
      ...
      PaperCheckCollectionResponse.new(payload,
                                       links)
    end
  end
end
