...
module Pqapiv2
  ...
  class TransferCollectionResponse < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [List of TransferResponse]
    ...
    def self.from_hash(hash)
      ...
      unless hash['payload'].nil?
        ...
        hash['payload'].each do |structure|
          payload << (TransferResponse.from_hash(structure) if structure)
        end
      end
      ...
      TransferCollectionResponse.new(payload,
                                     links)
    end
  end
end
