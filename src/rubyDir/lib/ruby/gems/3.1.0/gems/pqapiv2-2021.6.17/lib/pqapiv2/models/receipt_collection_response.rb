...
module Pqapiv2
  ...
  class ReceiptCollectionResponse < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [List of ReceiptBase]
    ...
    def self.from_hash(hash)
      ...
      unless hash['payload'].nil?
        ...
        hash['payload'].each do |structure|
          payload << (ReceiptBase.from_hash(structure) if structure)
        end
      end
      ...
      ReceiptCollectionResponse.new(payload,
                                    links)
    end
  end
end
