...
module Pqapiv2
  ...
  class BankAccountCollectionResponse < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [List of BankAccountResponse]
    ...
    def self.from_hash(hash)
      ...
      unless hash['payload'].nil?
        ...
        hash['payload'].each do |structure|
          payload << (BankAccountResponse.from_hash(structure) if structure)
        end
      end
      ...
      BankAccountCollectionResponse.new(payload,
                                        links)
    end
  end
end
