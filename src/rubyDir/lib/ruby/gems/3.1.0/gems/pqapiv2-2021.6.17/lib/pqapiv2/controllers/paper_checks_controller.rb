...
module Pqapiv2
  ...
  class PaperChecksController < BaseController
    ...
    # language type.
    # @return [PaperCheckCollectionResponse] response from the API call
    def list_paper_checks(user_token,
      ...
      _query_builder << '/users/{user-token}/paperchecks'
      ...
      PaperCheckCollectionResponse.from_hash(decoded)
    end
    ...
    # @param [String] x_my_pay_quicker_version Required parameter: Date-based
    # API Version specified in the header <i>required</i> on all calls.
    # @param [PaperCheckBase] body Optional parameter: Example:
    # @return [PaperCheckResponse] response from the API call
    def order_paper_check(user_token,
                          x_my_pay_quicker_version,
                          body: nil)
      # Prepare query url.
      _query_builder = config.get_base_uri
      ...
      # Return appropriate response type.
      decoded = APIHelper.json_deserialize(_response.raw_body)
      PaperCheckResponse.from_hash(decoded)
    end
    ...
    # language type.
    # @return [PaperCheckResponse] response from the API call
    def retrieve_paper_check(user_token,
                             xfer_token,
                             x_my_pay_quicker_version,
                             page: nil,
                             page_size: 20,
      ...
      # Prepare query url.
      _query_builder = config.get_base_uri
      _query_builder << '/users/{user-token}/paper-checks/{xfer-token}'
      _query_builder = APIHelper.append_url_with_template_parameters(
        _query_builder,
        'user-token' => { 'value' => user_token, 'encode' => true },
    ...
    # @return [PaperCheckResponse] response from the API call
    def update_paper_check(user_token,
                           xfer_token,
                           x_my_pay_quicker_version,
                           body: nil)
      # Prepare query url.
    ...
    def cancel_paper_check(user_token,
                           xfer_token,
                           x_my_pay_quicker_version)
      # Prepare query url.
      _query_builder = config.get_base_uri
