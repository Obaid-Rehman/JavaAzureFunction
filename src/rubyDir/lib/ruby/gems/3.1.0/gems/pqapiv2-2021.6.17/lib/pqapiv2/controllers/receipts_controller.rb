...
module Pqapiv2
  ...
  class ReceiptsController < BaseController
    ...
    def list_account_receipts(acct_token,
      ...
      _query_builder << '/accounts/{acct-token}/receipts'
    ...
    # @param [LanguageTypesEnum] language Optional parameter: Filter results by
    # language type.
    # @return [ReceiptCollectionResponse] response from the API call
    def list_prepaid_card_receipts(user_token,
      ...
      # Prepare query url.
      _query_builder = config.get_base_uri
      _query_builder << '/users/{user-token}/prepaid-cards/{dest-token}/receipts'
      _query_builder = APIHelper.append_url_with_template_parameters(
        _query_builder,
      ...
      ReceiptCollectionResponse.from_hash(decoded)
    end

    # Retrieve a list all user receipts that supports filtering, sorting, and
    ...
    def list_user_receipts(user_token,
      ...
      # Prepare query url.
      _query_builder = config.get_base_uri
      _query_builder << '/users/{user-token}/receipts'
      _query_builder = APIHelper.append_url_with_template_parameters(
        _query_builder,
        'user-token' => { 'value' => user_token, 'encode' => true }
      )
